...
<div class="wrapper">
  ...
  <div class="content-container">
    ...
    <div class="selection-panel">
      <h2 class="panel-title">Select Genres</h2>
    ...
    <div class="sliders-container">
      {#if selectedGenres.size === 0}
        <div class="empty-state">
          <h3>Select genres to view movie collections</h3>
          <p>Choose one or more genres above to see curated movie sliders.</p>
        </div>
      {:else}
        {#each Array.from(selectedGenres) as genre}
          <div class="slider-wrapper" key={genre}>
